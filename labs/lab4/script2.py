...
# function used to download the file, and ends with it printing the file downloaded to the designated end, also adds in an except if there is an error
    ...
    try:
        response = s3_client.generate_presigned_url('get_object',
                                                    Params={'Bucket': bucket_name,
                                                            'Key': object_name},
                                                    ExpiresIn=expires_in) #generates the s3 client
...
# I used all of the sources given in the homework this week!
